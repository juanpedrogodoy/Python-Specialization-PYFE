...
* **07_logic_tools_collection.py**: A collection of extra logic challenges (leap years, discounts, etc.) generated by AI to deepen my understanding.
...
* **Transparency:** Codes and comments reflect a real learning process, including terms in my native language (Spanish) to keep the journey authentic.
